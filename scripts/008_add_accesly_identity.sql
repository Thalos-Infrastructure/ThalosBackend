-- #109 — Accesly (passkey, non-custodial) identity persistence.
-- Reuses the auth_provider column planned in #108 (guarded with IF NOT EXISTS
-- so whichever migration runs first wins).
